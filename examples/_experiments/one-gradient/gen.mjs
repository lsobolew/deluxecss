...
//
// Run from the pixel-css dir:  node examples/_experiments/one-gradient/gen.mjs
...
<body>
  ...
  ${cmdBlock("node examples/_experiments/one-gradient/gen.mjs", "Generated by (bespoke experiment — hand-rolled, not the pixel-css CLI)")}
  ${backLink(2)}
</body></html>
`;
